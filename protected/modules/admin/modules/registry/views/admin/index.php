...
<p>
  <a href="<?= $this->createUrl('create') ?>" class="btn btn-success">
    ...
    <?= Yii::t('admin.translate.labels', 'Add Administrator Account') ?>
  </a>
</p>
...
<form method="post" id="mass" class="mass-actions" onsubmit="return processSelected()">
  ...
  <button name="enable" class="btn btn-success" type="submit"><i class="icon-ok-circle"></i> <?= Yii::t('common', 'Enable') ?></button>
  <button name="disable" class="btn btn-inverse" type="submit"><i class="icon-ban-circle"></i> <?= Yii::t('common', 'Disable') ?></button>
