...
<p>
  <a href="<?= $this->createUrl('create') ?>" class="btn btn-success">
    <i class="icon-plus-sign"></i> <?= Yii::t('admin.translate.labels', 'Add Message') ?>
  </a>
  <a href="<?= $this->createUrl('source') ?>" class="btn btn-primary">
    <i class="icon-download-alt"></i> <?= Yii::t('admin.translate.labels', 'Download Source Messages') ?>
  </a>
  <a href="<?= $this->createUrl('message/upload') ?>" class="btn btn-info">
    <i class="icon-upload-alt"></i> <?= Yii::t('admin.translate.labels', 'Upload Translations') ?>
  </a>
</p>
