...
<div class="row">
  <div class="span4">
    <p><a href="<?= $this->createUrl('create') ?>" class="btn btn-success btn-large btn-block"><i class="icon-plus-sign"></i> <?= Yii::t('admin.content.labels', 'Add Carousel') ?></a></p>
    <div class="well">
  ...
  <div class="span8">
    ...
    <form method="post" id="mass" class="mass-actions" onsubmit="return processSelected()">
      ...
      <div class="btn-group">
        <button name="enable" class="btn btn-success" type="submit">
          <i class="icon-ok-circle"></i> <?= Yii::t('common', 'Publish') ?>
        </button>
      </div>
      <div class="btn-group">
        <button name="disable" class="btn btn-inverse" type="submit">
          <i class="icon-ban-circle"></i> <?= Yii::t('common', 'Hide') ?>
        </button>
      </div>
      <div class="btn-group">
