<?php
/**
 * ViraCMS Uploaded Files Management Controller
 *
 ...
 */
class FileController extends VSystemCrudController
{
  ...
  public function getTitle($view, $params = array())
  {
    ...
    switch ($view) {
      case 'index':
        return Yii::t('admin.content.titles', 'Uploaded Files');

      case 'create':
        return Yii::t('admin.content.titles', 'New Upload');

      case 'view':
        return Yii::t('admin.content.titles', 'View File "{filename}"', array('{filename}' => $model->filename));

      case 'update':
        return Yii::t('admin.content.titles', 'Update File "{filename}"', array('{filename}' => $model->filename));

      case 'delete':
        return Yii::t('admin.content.titles', 'Delete File "{filename}"', array('{filename}' => $model->filename));

      case 'mass':
        return Yii::t('admin.content.titles', 'Mass action with files');
    }
  ...
  protected function getActionSuccessMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'create':
        return Yii::t('admin.content.messages', 'File "{filename}" has been successfully uploaded', array('{filename}' => $model->filename));

      case 'update':
        return Yii::t('admin.content.messages', 'File "{filename}" has been successfully updated', array('{filename}' => $model->filename));

      case 'delete':
        return Yii::t('admin.content.messages', 'File "{filename}" has been successfully removed', array('{filename}' => $model->filename));
    }
  ...
  public function getActionConfirmMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Are you sure to delete file "{filename}"?', array('{filename}' => $model->filename));
    }
  ...
  public function getMassActionConfirmMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Are you sure to delete selected files?');
    }
  ...
  public function getMassActionSuccessMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Files has been successfully removed');
    }
  ...
  {
    return Yii::t('admin.content.errors', 'File not found');
  }
  ...
  {
    return new VContentFile($scenario);
  }

  public function getPlainModel($scenario)
  {
    return VContentFile::model();
  }
}
