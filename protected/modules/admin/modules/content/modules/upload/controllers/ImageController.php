<?php
/**
 * ViraCMS Uploaded Images Management Controller
 *
 ...
 */
class ImageController extends VSystemCrudController
{
  ...
  public function getTitle($view, $params = array())
  {
    ...
    switch ($view) {
      case 'index':
        return Yii::t('admin.content.titles', 'Uploaded Images');

      case 'create':
        return Yii::t('admin.content.titles', 'New Upload');

      case 'view':
        return Yii::t('admin.content.titles', 'View Image "{filename}"', array('{filename}' => $model->filename));

      case 'update':
        return Yii::t('admin.content.titles', 'Update Image "{filename}"', array('{filename}' => $model->filename));

      case 'delete':
        return Yii::t('admin.content.titles', 'Delete Image "{filename}"', array('{filename}' => $model->filename));

      case 'mass':
        return Yii::t('admin.content.titles', 'Mass action with images');
    }
  ...
  protected function getActionSuccessMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'create':
        return Yii::t('admin.content.messages', 'Image "{filename}" has been successfully uploaded', array('{filename}' => $model->filename));

      case 'update':
        return Yii::t('admin.content.messages', 'Image "{filename}" has been successfully updated', array('{filename}' => $model->filename));

      case 'delete':
        return Yii::t('admin.content.messages', 'Image "{filename}" has been successfully removed', array('{filename}' => $model->filename));
    }
  ...
  public function getActionConfirmMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Are you sure to delete image "{filename}"?', array('{filename}' => $model->filename));
    }
  ...
  public function getMassActionConfirmMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Are you sure to delete selected images?');
    }
  ...
  public function getMassActionSuccessMessage($action, $params = array())
  {
    ...
    switch ($action) {
      case 'delete':
        return Yii::t('admin.content.messages', 'Images has been successfully removed');
    }
  ...
  {
    return Yii::t('admin.content.errors', 'Image not found');
  }
  ...
  {
    return new VContentImage($scenario);
  }

  public function getPlainModel($scenario)
  {
    return VContentImage::model();
  }
}
