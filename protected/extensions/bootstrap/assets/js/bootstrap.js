...
!function ( $ ) {
  ...
  DatePicker.prototype = {
    ...
    , init: function() {
		...
		var $select = $("<div>").addClass('selection');
		$select.append('<a class="now" href="#">' + this.todayButtonText + '</a><a class="clear" href="#">' + this.clearButtonText + '</a>');
		...
		$select.find('a').click($.proxy(function(e){
		  e.preventDefault();
		  if ($(e.target).hasClass('clear')) {
            this.update('','0000-00-00');
            this.hide();
		  }
		  else {
