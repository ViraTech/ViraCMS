...
class TbActiveForm extends CActiveForm
{
  ...
  /**
   * Renders a date picker field row.
   * @param CModel $model the data model
   * @param string $attribute the attribute
   * @param array $htmlOptions additional HTML attributes
   * @return string the generated row
   * @since 0.9.5
   */
  public function datepickerFieldRow($model, $attribute, $htmlOptions = array())
  {
  ...
  protected function inputsList($checkbox, $model, $attribute, $data, $htmlOptions = array())
  {
    ...
    if (isset($htmlOptions['labelCssClass'])) {
      $labelCssClass = $htmlOptions['labelCssClass'];
      unset($htmlOptions['labelCssClass']);
    }
    else {
