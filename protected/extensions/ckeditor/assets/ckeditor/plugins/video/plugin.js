...
var ru = {
		toolbar	: 'Видео HTML5 (WebM,MP4)',
		dialogTitle : 'Свойства видео',
		fakeObject : 'Видео',
		properties : 'Изменить видео',
		widthRequired : 'Укажите ширину',
		heightRequired : 'Укажите высоту',
		poster: 'Изображение для видео',
		sourceVideo: 'Видеофайл',
		sourceType : 'Тип видеофайла',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Your browser doesn\'t support video.<br>Please download the file: %links%'
	};
