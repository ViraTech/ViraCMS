  ...
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="javascript:void(0)">
        ...
        <small><?= Yii::t('vira_editor', 'Video Browser') ?></small>
      </a>
...
<div class="container">
  <div class="row">
    <div class="span4">
        ...
        <form id="activate-filter">
          ...
          <div class="filter-select">
            <?= CHtml::dropDownList('group', 'object', array(
              'object' => Yii::t('vira_editor', 'Current Object Video Files'),
              'model'  => Yii::t('vira_editor', 'This Section Video Files'),
              'all'    => Yii::t('vira_editor', 'All Video Files'),
      ...
      <div class="row-fluid">
        <?php $this->widget('application.extensions.fineuploader.EFineUploader', array(
          ...
          'allowedExtensions'  => explode(',', Yii::app()->params[ 'allowVideoTypes' ]),
          'acceptFiles'        => '.' . str_replace(',', ',.', Yii::app()->params[ 'allowVideoTypes' ]),
          'sizeLimit'          => '',
          'minSizeLimit'       => 100,
          'uploadButton'       => '<i class="icon-upload"></i> ' . Yii::t('vira_editor', 'Select Video File'),
          ...
          '</div>',
          'onCompleteCallback' => "js:function(id, fileName, responseJSON) { $.fn.yiiListView.update('select-video',{ data: $('#activate-filter').serialize() }); }",
    ...
    <div class="span8">
      <div class="row-fluid">
        <div class="span8">
          <h3><?= Yii::t('vira_editor', 'Select Video File') ?></h3>
        </div>
        <div class="span4">
      ...
      <?php $this->renderPartial(
        ($viewFile = $this->getViewFile('thumbnails')) != false ? $viewFile :
          'application.components.ViraEditor.views.browse.video.thumbnails', array(
        'model'  => $model,
        'view'   => $view,
        'params' => $params,
        )
