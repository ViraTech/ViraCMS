  ...
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="javascript:void(0)">
        ...
        <small><?= Yii::t('vira_editor', 'Flash Browser') ?></small>
      </a>
...
<div class="container">
  <div class="row">
    <div class="span4">
        ...
        <form id="activate-filter">
          ...
          <div class="filter-select">
            <?= CHtml::dropDownList('group', 'object', array(
              'object' => Yii::t('vira_editor', 'Current Object Flash Files'),
              'model'  => Yii::t('vira_editor', 'This Section Flash Files'),
              'all'    => Yii::t('vira_editor', 'All Flash Files'),
      ...
      <div class="row-fluid">
        <?php $this->widget('application.extensions.fineuploader.EFineUploader', array(
          ...
          'allowedExtensions'  => explode(',', Yii::app()->params[ 'allowFlashTypes' ]),
          'acceptFiles'        => '.' . str_replace(',', ',.', Yii::app()->params[ 'allowFlashTypes' ]),
          'sizeLimit'          => '',
          'minSizeLimit'       => 100,
          ...
          '</div>',
          'onCompleteCallback' => "js:function(id, fileName, responseJSON) { $.fn.yiiListView.update('select-flash',{ data: $('#activate-filter').serialize() }); }",
    ...
    <div class="span8">
      <div class="row-fluid">
        <div class="span8">
          <h3><?= Yii::t('vira_editor', 'Select Flash Object') ?></h3>
        </div>
        <div class="span4">
      ...
      <?php $this->renderPartial(
        ($viewFile = $this->getViewFile('thumbnails')) != false ? $viewFile :
          'application.components.ViraEditor.views.browse.flash.thumbnails', array(
        'model'  => $model,
        'view'   => $view,
        'params' => $params,
        )
