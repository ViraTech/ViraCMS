...
<?php $this->widget('bootstrap.widgets.TbThumbnails', array(
  ...
  'itemView' => ($viewFile = $this->getViewFile($view)) != false ? $viewFile : ('application.components.ViraEditor.views.browse.flash.' . $view),
  'htmlOptions' => array(
    'style' => 'padding-top: 0;',
  ),
  'listCssClass' => $view == 'list' ? 'unstyled' : 'thumbnails',
  'ajaxUrl' => $this->createUrl(Yii::app()->editor->flashBrowserAction),
)); ?>
