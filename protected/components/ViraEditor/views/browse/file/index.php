  ...
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="javascript:void(0)">
        ...
        <small><?= Yii::t('vira_editor', 'File Browser') ?></small>
      </a>
...
<div class="container">
  <div class="row">
    <div class="span4">
        ...
        <form id="activate-filter">
          ...
          <div class="filter-select">
            <?= CHtml::dropDownList('group', 'object', array(
              'object' => Yii::t('vira_editor', 'Current Object Files'),
              'model'  => Yii::t('vira_editor', 'This Section Files'),
              'all'    => Yii::t('vira_editor', 'All Files'),
      ...
      <div class="row-fluid">
        <?php $this->widget('application.extensions.fineuploader.EFineUploader', array(
          ...
          '</div>',
          'onCompleteCallback' => "js:function(id,fileName,responseJSON) { $.fn.yiiListView.update('select-file',{ data: $('#activate-filter').serialize() }); }",
    ...
    <div class="span8">
      <div class="row-fluid">
        <div class="span8">
          <h3><?= Yii::t('vira_editor', 'Select File') ?></h3>
        </div>
      </div>
      <?php $this->renderPartial(
        ($viewFile = $this->getViewFile('thumbnails')) != false ? $viewFile :
          'application.components.ViraEditor.views.browse.file.thumbnails', array(
        'model'  => $model,
        'params' => $params,
        )
      ); ?>
